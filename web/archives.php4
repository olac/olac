<?php
#
# Synopsis: Display a summary of OLAC 1.0 database.
#
# ChangeLog:
#
# 2004-11-10  Haejoong Lee  <haejoong@ldc.upenn.edu>
#	* set character encoding to utf-8
# 2004-02-20  Steven Bird <sb@cs.mu.oz.au>
#       * add report cards, adjust font size
# 2003-02-28  Haejoong Lee  <haejoong@ldc.upenn.edu>
#	* revison of previous version built on 0.4 database
#
...
<td class=sec><font color=#ff9090><b>ARCHIVES</b></font></td><td>|</td>
...
<td class=sec><a href="services.php4">SERVICES</a></td><td>|</td>
...
if ($tab) foreach ($tab as $row) {
  echo "<tr>";
  echo "<td><b>$row[archive]</b><br>&nbsp;&nbsp;&nbsp;&nbsp;";
  if ($row[institution]) {
    echo "$row[institution], ";
  }
  echo "$row[location]</td>";
  echo "<td class=arch>$row[detail]</td>";
  echo "<td>&nbsp;</td>";
  echo "<td class=arch>$row[report]</td>";
  echo "<td>&nbsp;</td>";
  echo "<td class=arch>$row[iso639]</td>";
  echo "</tr><tr><td></td></tr>";
}
?>
</table>
