<?php
  ...
  $olaca_entry = '<tr><td><a href="http://www.language-archives.org/">OLACA: OLAC-Aggregator</a></td><td class=repo><b><a href="http://oai.dlib.vt.edu/~oai/cgi-bin/Explorer/oai1.1/testoai?archive=http://www.language-archives.org/cgi-bin/olaca.pl">&nbsp;REPOSITORY&nbsp;</a></b></td></tr>';
...
<form action="http://www.language-archives.org/tools/search.php4"
      method="get">
  <table class=banner>
  <tr><td class=sec><b>QUERY OLAC ARCHIVES:</b>
<br><a href="tools/archive_summary.php4">[HARVESTED ARCHIVES]</a>
...
<tr><td>
  ...
  <td class=repo><b>
  <a href="http://www.language-archives.org/tools/search.php4">&nbsp;SEARCH&nbsp;</a>
</td></tr>
...
http://www.language-archives.org/register/archive_list.php4</a>
