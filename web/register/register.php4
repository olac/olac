...
define(OLAC_PATH, '/mnt/unagi/speechd8/ldc/wwwhome/htdocs/language-archives');
define(OLAC_TOOLS, '/mnt/unagi/speechd8/ldc/wwwhome/olac');
...
define(DR_STRON,      'scripts/olac-dynamic-repository.xsl');
define(SR_STRON,      'scripts/olac-static-repository.xsl');
define(XSV_TRANSFORM, 'scripts/xsv_output_transform.xsl');
...
<p>This is a registration interface for <b>OLAC 1.0</b> archives.
...
<li>The repository doesn't conform to the OLAC 1.0 standards,</li>
<li>etc.</li>
</ul>
