   ...
   <xsl:template match="header">
      ...
      <table cellspacing="10">
            ...
            <tr valign="top">
               ...
               <td>
                  <xsl:choose>
                     <xsl:when test="status/@supersededBy">
                        <a>
                           <xsl:attribute name="href"><xsl:value-of select="$baseURL"/><xsl:value-of select="status/@supersededBy"/><xsl:text>-</xsl:text><xsl:value-of select="status/@endDate"/><xsl:text>.html</xsl:text></xsl:attribute>
         ...
         <tr valign="top">
            ...
            <td>
               <a>
                  <xsl:attribute name="href"><xsl:value-of select="$baseURL"/><xsl:value-of select="baseName"/><xsl:text>-</xsl:text><xsl:value-of select="issued"/><xsl:text>.html</xsl:text></xsl:attribute>
                  <xsl:value-of select="$baseURL"/>
         ...
         <xsl:if test="not(status[@endDate])">
            <tr valign="top">
               ...
               <td>
                  <a>
                     <xsl:attribute name="href"><xsl:value-of select="$baseURL"/><xsl:value-of select="baseName"/><xsl:text>.html</xsl:text></xsl:attribute>
                     <xsl:value-of select="$baseURL"/>
                     <xsl:value-of select="baseName"/>
                     <xsl:text>.html</xsl:text>
                  </a>
         ...
         <tr valign="top">
            ...
            <td>
               <xsl:choose>
                  ...
                  <xsl:otherwise>
                     <a>
                        <xsl:attribute name="href"><xsl:value-of select="$baseURL"/><xsl:value-of select="baseName"/><xsl:text>-</xsl:text><xsl:value-of select="previousIssued"/><xsl:text>.html</xsl:text></xsl:attribute>
                        <xsl:value-of select="$baseURL"/>
                        <xsl:value-of select="baseName"/>
                        <xsl:text>-</xsl:text>
      ...
      <blockquote>
         <small>
            ...
            <xsl:text>. This material may be distributed only subject to the terms and conditions set forth in the Creative Commons Attribution ShareAlike License, available at </xsl:text>
            <a href="http://www.creativecommons.org/">
               <xsl:text>http://www.creativecommons.org/</xsl:text>
            </a>
            <xsl:text>.</xsl:text>
         </small>
      </blockquote>
