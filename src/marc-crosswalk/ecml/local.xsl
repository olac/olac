...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="marc:record" mode="record-id">
        <xsl:value-of select="substring(marc:controlfield[@tag=035] , 8)"/>
    </xsl:template>
            ...
            <oai:description>
              ...
              http://www.language-archives.org/OLAC/1.1/olac-archive.xsd">
               ...
               -->
                    ...
                    <participant name="Catherine Seewald" role="Documentalist" email="catherine.seewald@ecml.at"/>
                    <participant name="Waldemar Martyniuk" role="Executive Director" email="waldemar.martyniuk@ecml.at"/>
