...
<!-- 
   ...
   For repository: Vining Collection, Gordon College
   Developed by: Gary Simons
...
<xsl:stylesheet version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/"
   ...
   <xsl:variable name="metadata-version-date">2018-04-02</xsl:variable>

   <!-- Fill in today's date (as the date as of which the archive
      description and participant list is current) -->
   <xsl:variable name="current-as-of-date">2018-04-02</xsl:variable>

   <!-- Fill in the web domain name that uniquely identifies your
      archive -->
   <xsl:variable name="repository-id">gordon.edu</xsl:variable>
   ...
   <xsl:template name="identify-response">
      <Identify xmlns="http://www.openarchives.org/OAI/2.0/static-repository"
        ...
        http://www.openarchives.org/OAI/2.0/
         ...
         <oai:repositoryName>Vining Collection, Gordon College</oai:repositoryName>
         <!-- Fill in the URL where the static repository resides on the web -->
         <oai:baseURL>http://www.gordon.edu/library/olac_repository.xml</oai:baseURL>
         <!-- Don't touch this -->
         ...
         <oai:description>
            <olac-archive currentAsOf="{$current-as-of-date}" type="institutional"
              ...
              http://www.language-archives.org/OLAC/1.1/olac-archive.xsd">
               ...
               <access>Items are available for checkout to all GIAL faculty and students, members of
                  Bible translation organizations, and International Linguistics Center employees
