         ...
         <oai:description>
            <olac-archive currentAsOf="{$current-as-of-date}" type="institutional"
              ...
              http://www.language-archives.org/OLAC/1.1/olac-archive.xsd">
               ...
               <participant email="library_dallas@gial.edu" name="Ferne Weimer"
               ...
               <location>The GIAL Library is located in the Pike Building (A1) on the International
                  Linguistics Center at 7500 W. Camp Wisdom Road, Dallas, TX 75236. </location>
               ...
               <access>The library stacks are open to visitors. Items are available for checkout to
                  GIAL faculty and students, and to International Linguistics Center employees and
                  volunteers.</access>
            </olac-archive>
         </oai:description>
      </Identify>
