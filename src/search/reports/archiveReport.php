...
#
# CVS Info: $Header: /cvsroot/olac/olac_suite/mu_tools/reports/archiveReport.php,v 1.5 2005/03/31 11:01:14 badenh Exp $
##########
...
function main( $archiveID )
{
	...
	<sub><a href='UserGuide.html#Archive_Diversity'>*</a></sub></h2>\n";
    archiveDiversity( $archiveID, $DB );

    print "<h2>Metadata Quality
	<sub><a href='UserGuide.html#Metadata_Quality'>*</a></sub></h2>\n";
    archiveItemRanks( $archiveID, $DB, $maxItemScore );

    print "<h2>Core Elements Per Record
	<sub><a href='UserGuide.html#Core_Tags_Per_Record'>*</a>
	</sub></h2>\n";
    archiveCoreTagsPerRecord( $archiveID, $DB );

    print "<h2>Core Element Usage
	<sub><a href='UserGuide.html#Core_Tag_Usage'>*</a></sub></h2>\n";
    archiveCoreTagUsage( $archiveID, $DB );

    print "<h2>Code Usage
	<sub><a href='UserGuide.html#Code_Usage'>*</a></sub></h2>\n";
    archiveCodeUsage( $archiveID , $DB );

    print "<h2>Element and Code Usage
	<sub><a href='UserGuide.html#Tag_And_Code_Usage'>*</a></sub>
	</h2>\n";
...
print "</td><td align=right>
		<a href='UserGuide.html'>Report Card User Guide</a>
		<BR>
		<A HREF='mailto:olac-archivereports-dev@cs.mu.oz.au'>Contact Support</A>
	</td></tr></table>";
