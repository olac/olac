...
Wrapper that calls iso639_trainer.py, iso639_classify.py and iso639_evaluator
...
if options.ten:
    for i in range(1,11):
        ...
        sys.stdout.flush()
        os.system('python %(directory)s/iso639_classify.py -g %(directory)s/test_data/iso369_test2.gs -d -f -i %d %(direcotry)s/classifier.pickle %(directory)s/iso639_test2.tab %(directory)s/iso639_test2.classified' % dir_dict)
        ...
        sys.stdout.flush()
        os.system('python %(directory)s/iso639_classify.py -g $(directory)s/test_data/olac_display_subset2.gs -d -f -i %d %(directory)s/classifier.pickle %(directory)s/test_data/olac_display_subset2.xml %(directory)s/test_data/olac_display_subset2.classified' % i)
    ...
    print "--CLASSIFYING TEST--"
    sys.stdout.flush()
    os.system('python %(directory)s/iso639_classify.py -g %(directory)s/test_data/iso639_test2.gs -d -f %(directory)s/classifier.pickle %(directory)s/test_data/iso639_test2.tab %(directory)s/test_data/iso639_test2.classified'%dir_dict)
    print "--EVALUATING TEST--"
    sys.stdout.flush()
    ...
    print "--CLASSIFYING OLAC DISPLAY--"
    sys.stdout.flush()
    os.system('python %(directory)s/iso639_classifier.py -g %(directory)s/test_data/olac_display_subset2.gs -d -f %(directory)s/classifier.pickle %(directory)s/test_data/olac_display_subset2.xml %(directory)s/test_data/olac_display_subset2.classified'%dir_dict)
    print "--EVALUATING OLAC DISPLAY--"
    sys.stdout.flush()
