...
classifierFile="../typemulti_m-1.classifier.mallet"

echo "Starting classifier server..."
# parentheses make a "double-fork" so the process continues after the shell exits
(java -Xms32m -Xmx256m ResourceTypeClassifierServer $classifierFile > server.log 2>&1 &)
