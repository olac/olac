...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="process-linguistic-subject">
        ...
        <xsl:if test="starts-with($subject,'Case grammar')">
            <dc:subject xsi:type="olac:linguistic-field">syntax</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Cohesion (Linguistics)')">
            <dc:subject xsi:type="olac:linguistic-field">discourse_analysis</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Computational linguistics')">
            <dc:subject xsi:type="olac:linguistic-field">computational_linguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Court interpreting and translating')">
            <dc:subject xsi:type="olac:linguistic-field">translating_and_interpreting</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Diglossia (Linguistics)')">
            <dc:subject xsi:type="olac:linguistic-field">sociolinguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Forensic linguistics')">
            <dc:subject xsi:type="olac:linguistic-field">forensic_linguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Glossematics')">
            <dc:subject xsi:type="olac:linguistic-field">mathematical_linguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Grammar, Comparative and general--Inflection')">
            <dc:subject xsi:type="olac:linguistic-field">morphology</dc:subject>
        </xsl:if>
        <xsl:if
        ...
        <xsl:if test="starts-with($subject,'Historical linguistics')">
            <dc:subject xsi:type="olac:linguistic-field">historical_linguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Language acquisition')">
            <dc:subject xsi:type="olac:linguistic-field">language_acquisition</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Language and languages--Universals')">
            <dc:subject xsi:type="olac:linguistic-field">typology</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Linguistics--History')">
            <dc:subject xsi:type="olac:linguistic-field">history_of_linguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Neurolinguistics')">
            <dc:subject xsi:type="olac:linguistic-field">neurolinguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:if test="starts-with($subject,'Pragmatics')">
            <dc:subject xsi:type="olac:linguistic-field">pragmatics</dc:subject>
        </xsl:if>
        <xsl:if test="starts-with($subject,'Prosodic analysis (Linguistics)')">
            <dc:subject xsi:type="olac:linguistic-field">phonetics</dc:subject>
        </xsl:if>
        <xsl:if test="starts-with($subject,'Psycholinguistics')">
            <dc:subject xsi:type="olac:linguistic-field">psycholinguistics</dc:subject>
        </xsl:if>
        ...
        <xsl:for-each select="marc:subfield[@code='v']">
            <xsl:if test="starts-with( . ,'Texts')">
                <dc:subject xsi:type="olac:linguistic-field">language_documentation</dc:subject>
            </xsl:if>
        </xsl:for-each>
