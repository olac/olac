    ...
    <xsl:template name="process-DCMI-Type">
        ...
        <dc:type xsi:type="dcterms:DCMIType">
            <xsl:attribute name="from_marc_field">
                <xsl:choose>
                    <!-- CJH: replaced by string function below: <xsl:when test="$leader6='a' or $leader6='t' or $leader6='e' or $leader6='f' or $leader6='c' or $leader6='d' or $leader6='i' or $leader6='j' or $leader6='k' or $leader6='g' or $leader6='r' or $leader6='m' or $leader6='p'">leader6</xsl:when>
                    -->
