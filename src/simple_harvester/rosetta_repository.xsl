...
<!-- 
     ...
     rosettaproject collection at the Internet Archive to an OLAC
     static repository.
     
     The input data file is created by running rosetta_harvest_v2.py.
     It starts with the request: 
     
        http://www.archive.org/services/oai.php?verb=ListRecords&metadataPrefix=oai_dc&set=collection:rosettaproject
     ...
     collection:rosettaproject_audio and collection:rosettaproject_movies
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
   ...
   <xsl:variable name="metadata-version-date">2010-09-21</xsl:variable>
   ...
   <xsl:variable name="current-as-of-date">2010-09-21</xsl:variable>
   
   <!-- Fill in the web domain name that uniquely identifies your
      archive -->
   <xsl:variable name="repository-id">rosettaproject.org</xsl:variable>
      ...
      <sr:Identify>
         ...
         <oai:description>
            <olac-archive currentAsOf="{$current-as-of-date}"
               ...
               <archiveURL>http://www.rosettaproject.org/</archiveURL>
               <participant email="laura@longnow.org"
                  name="Laura Welcher" role="Director of The Rosetta Project"/>
               <participant email="jcgood@buffalo.edu"
                  name="Jeff Good" role="Technical Director of The Rosetta Project"/>
               <participant email="kurt@longnow.org"
                  name="Kurt Bollacker" role="Digital Research Director"/>
               <participant email="ben@longnow.org"
                  name="Ben Keating" role="Web Developer"/>
               <institution>Long Now Foundation</institution>
               <institutionURL>http://www.longnow.org/</institutionURL>
               <shortLocation>San Francisco, CA</shortLocation>
               <location>The offices of the Rosetta Project are
                  located in the Fort Mason Center, Landmark Building
                  A, San Francisco, CA 94123. </location>
               <synopsis>The Rosetta Project collection has grown to 
                  over 100,000 pages of documents, as well as language
                  recordings, for over 2,500 languages. The collection 
                  is now housed as a special collection in the Internet
                  Archive, and we continue to expand the collection 
                  through new materials and contributions. </synopsis>
               <access>All holdings of the collection are freely
                  accessible online as a special collection within the Internet Archive.</access>
               <archivalSubmissionPolicy>The Rosetta Project accepts a
                  wide variety of materials that help document the
                  languages of the world. If you would like to help
                  build this open public collection through materials
                  you have assembled or created, please contact
                  rosetta@longnow.org and tell us more about
                  them.</archivalSubmissionPolicy>
            </olac-archive>
         </oai:description>
      </sr:Identify>
   </xsl:template>
