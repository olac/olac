...
<xsl:template match="/marc:collection">
    ...
    <xsl:template match="marc:datafield[@tag='041']">
        <xsl:choose>
            <xsl:when test="translate(marc:subfield[@code='2'],'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ') = 'iso639-2'">
            ...
            <xsl:when test="translate(marc:subfield[@code='2'],'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ') = 'iso639-3'">
                <xsl:call-template name="process-041">
                    <xsl:with-param name="xsitype">dcterms:ISO639-3</xsl:with-param>
                    <xsl:with-param name="str" select="marc:subfield[@code='a']"/>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="translate(marc:subfield[@code='2'],'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ') = 'rfc1766'">
                <dc:language xsi:type="dcterms:RFC1766">
                    <xsl:call-template name="show-source"/>
                    <xsl:value-of select="marc:subfield[@code='a']"/>
                </dc:language>
            </xsl:when>
            <xsl:when test="translate(marc:subfield[@code='2'],'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ') = 'rfc3066'">
                <dc:language xsi:type="dcterms:RFC3066">
                    <xsl:call-template name="show-source"/>
                    <xsl:value-of select="marc:subfield[@code='a']"/>
                </dc:language>
            </xsl:when>
            <xsl:when test="translate(marc:subfield[@code='2'],'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ') = 'rfc4646'">
    ...
    <xsl:template name="process-041">
        ...
        <xsl:param name="str" />
        <xsl:choose>
            <xsl:when test="count(node-set($str)) = 1">
    ...
    <xsl:template match="marc:datafield[@tag='650']">
        <xsl:choose>
            <xsl:when test="@ind2='0'">
                ...
                <dc:subject xsi:type="dcterms:LCSH">
                    <xsl:if test="$show-source and $code = '' and contains( translate( . ,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ') ,'language')">
    ...
    <xsl:template name="process-856">
        <xsl:choose>
            <xsl:when
                test="marc:subfield[@code='3' and contains(translate( . ,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),'abstract') or 
                contains(translate( . ,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),'summary') or 
                contains(translate( . ,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),'description')]">
                <dcterms:abstract from="856" xsi:type="dcterms:URI">
                    <xsl:value-of select="marc:subfield[@code='u']"/>
                </dcterms:abstract>
            </xsl:when>
            <xsl:when test="marc:subfield[@code='3' and contains(translate( . ,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),'contents')]">
