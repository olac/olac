...
(1) Relevant resources do exist as web pages, but their visibility is
{\it occluded} by fuzziness of search terms and 
descriptors on the page.
(2) Relevant resources are accessible from the web, but they are completely
...
archives that hold them have not published their catalogs on the web.
...
The project seeks to do so through two main areas of activity:
...
Objective 1 addresses the problem of occluded and missing resources, while
objective 2 addresses hidden resources.
...
adopt best practices in digital archiving and deposit their own work
in language archives that will make it
accessible to others through the same means. 
...
(iii) a score card system which publishes a metadata quality score
