...
that the current coverage (with 30,000 items cataloged) is only the 
...
engine with vastly increased coverage will become such a popular tool
among linguiss that it will provide powerful incentive for them to
